...
// 7- Використовуючи данні з масиву, за допомоги document.write та циклу
// побудувати структуру по шаблону
...
for (const product of products) {
    ...
    document.write(`</h3>`);
    document.write(`<img src=${product.image} alt=${product.title} height="150px" class="product-image">`);
    document.write(`</div>`);
}
...
// 8 - користувачів які старші за 30 років
for (const user of users) {
    if (user.age > 30) {
        console.log(user);
    }
